    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="w-full max-w-md space-y-8 p-8 bg-white/5 border border-white/10 rounded-2xl backdrop-blur-xl">
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold tracking-tight text-white uppercase italic">Create Account</h2>
          <p className="mt-2 text-sm text-gray-400 font-medium">Join the ApexFlow telemetry network</p>
        </div>

        {isSuccess ? (
          <div className="p-8 text-center space-y-4 bg-white/5 border border-white/10 rounded-2xl">
            <div className="inline-flex w-16 h-16 bg-green-500/20 text-green-500 rounded-full items-center justify-center mb-2">
              <UserPlus size={32} />
            </div>
